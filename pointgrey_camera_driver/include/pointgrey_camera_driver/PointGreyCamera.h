...
#include <pointgrey_camera_driver/PointGreyConfig.h> // Necessary include for use of dynamic reconfigure and its config object.
#include "FlyCapture2.h" // Necessary include of the FlyCapture2 library from Point Grey.

#include <pointgrey_camera_driver/camera_exceptions.h> // Custom exception type
